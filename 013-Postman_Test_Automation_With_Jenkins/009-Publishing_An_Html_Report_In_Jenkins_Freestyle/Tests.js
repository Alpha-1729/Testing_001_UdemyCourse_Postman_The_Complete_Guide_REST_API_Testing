 ...
 *   Open Build Steps → Add these commands in the Execute Shell.
 *     newman --version
 ...
 *   Jenkins distributes files like this one with a content security policy, CSP as an HTTP header.
 *   By default, the CSP header is configured to prohibit various web features in order to guard
 *   against cross-site scripting and other threats against users of Jenkins who access these files.
 *   That is why we cannot see this report properly.
 *
